...
export default function ReportTable() {
  ...
  return (
    <div className="space-y-6">
      {/* HEADER */}
      <div>
        <h1 className="text-3xl font-bold text-[#800000]">Laporan Donasi</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
        <div className="bg-white p-5 rounded-2xl shadow-sm border">
          <div className="flex justify-between">
            <div>
              ...
              <h2 className="text-2xl font-bold mt-2">Rp 125 Jt</h2>
            </div>
        ...
        <div className="bg-white p-5 rounded-2xl shadow-sm border">
          <div className="flex justify-between">
            <div>
              <p className="text-gray-500 text-sm">Campaign Aktif</p>
        ...
        <div className="bg-white p-5 rounded-2xl shadow-sm border">
          <div className="flex justify-between">
            <div>
              <p className="text-gray-500 text-sm">Penyaluran</p>

              <h2 className="text-2xl font-bold mt-2">Rp 95 Jt</h2>
            </div>
        ...
        <table className="w-full">
          <thead className="bg-[#800000] text-white">
            <tr>
              ...
              <th className="p-4 text-left">Total Donasi</th>
              <th className="p-4 text-left">Total Penyaluran</th>
              <th className="p-4 text-left">Jumlah Donatur</th>
          ...
          <tbody>
            {reports.map((report) => (
              <tr key={report.id} className="border-b hover:bg-gray-50">
                <td className="p-4 font-medium">{report.periode}</td>

                <td className="p-4">{report.totalDonasi}</td>

                <td className="p-4">{report.totalPenyaluran}</td>

                <td className="p-4">{report.donatur}</td>
